      ...
      <section className="py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="font-medium text-gray-800 mb-3">
              Join us in reimagining your home with furniture that speaks to your style and elevates your everyday living experience. At Funiro, we’re not just furnishing spaces; we’re crafting lifestyles.
            </p>
          </motion.div>
